...
# [{year:2012,rural:2323,urban:234},{year:2012,rural:2323,urban:234}]
...
data = Reference(ws, min_col=2, min_row=1, max_row=len(years)+1, max_col=len(years[0]))
...
chart1.type = "col"
chart1.style = 10
chart1.title = "CPI Sudan "+charType[0].upper()+charType[1:]
chart1.y_axis.title = 'Years'
